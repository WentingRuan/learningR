...
<!--html_preserve--><div id="plot_id122440854-container" class="ggvis-output-container">
...
<li>
<a id="plot_id122440854_download" class="ggvis-download" data-plot-id="plot_id122440854">Download</a>
</li>
</ul>
</nav>
</div>
...
<!--html_preserve--><div id="plot_id668246372-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id931234985-container" class="ggvis-output-container">
...
<li>
<a id="plot_id931234985_download" class="ggvis-download" data-plot-id="plot_id931234985">Download</a>
</li>
</ul>
</nav>
</div>
...
<!--html_preserve--><div id="plot_id769927880-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id204546606-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id639620151-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id976124922-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id629124777-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id364223870-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id789999717-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id581531563-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id473904740-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id508958436-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id328606720-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id405771007-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id915169472-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id415639209-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id422498288-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id495832268-container" class="ggvis-output-container">
...
<!--html_preserve--><div id="plot_id191614720-container" class="ggvis-output-container">
...
<li>
Renderer: 
<a id="plot_id191614720_renderer_svg" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id191614720" data-renderer="svg">SVG</a>
 | 
<a id="plot_id191614720_renderer_canvas" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id191614720" data-renderer="canvas">Canvas</a>
</li>
<li>
<a id="plot_id191614720_download" class="ggvis-download" data-plot-id="plot_id191614720">Download</a>
</li>
</ul>
</nav>
</div>
...
ggvis.getPlot("plot_id191614720").parseSpec(plot_id191614720_spec);
</script><!--/html_preserve-->
...
<!--html_preserve--><div id="plot_id747779086-container" class="ggvis-output-container">
<div id="plot_id747779086" class="ggvis-output"></div>
<div class="plot-gear-icon">
<nav class="ggvis-control">
<a class="ggvis-dropdown-toggle" title="Controls" onclick="return false;"></a>
<ul class="ggvis-dropdown">
<li>
Renderer: 
<a id="plot_id747779086_renderer_svg" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id747779086" data-renderer="svg">SVG</a>
 | 
<a id="plot_id747779086_renderer_canvas" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id747779086" data-renderer="canvas">Canvas</a>
</li>
<li>
<a id="plot_id747779086_download" class="ggvis-download" data-plot-id="plot_id747779086">Download</a>
</li>
</ul>
</nav>
</div>
  ...
  "data": [
    {
      ...
      "values": "\"y - 0.1\",\"x\",\"y + 0.1\"\n0.427134453644976,1,0.627134453644976\n0.0643282137811184,2,0.264328213781118\n0.210000959783792,3,0.410000959783792\n0.72112341048196,4,0.92112341048196\n0.532165763992816,5,0.732165763992816\n0.64968667072244,6,0.84968667072244\n0.686571428645402,7,0.886571428645402\n0.797739671403542,8,0.997739671403542\n0.879318287922069,9,1.07931828792207\n0.0169117165263742,10,0.216911716526374"
    },
    {
      "name": "scale/x",
      "format": {
...
ggvis.getPlot("plot_id747779086").parseSpec(plot_id747779086_spec);
</script><!--/html_preserve-->
...
<!--html_preserve--><div id="plot_id178319944-container" class="ggvis-output-container">
<div id="plot_id178319944" class="ggvis-output"></div>
<div class="plot-gear-icon">
<nav class="ggvis-control">
<a class="ggvis-dropdown-toggle" title="Controls" onclick="return false;"></a>
<ul class="ggvis-dropdown">
<li>
Renderer: 
<a id="plot_id178319944_renderer_svg" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id178319944" data-renderer="svg">SVG</a>
 | 
<a id="plot_id178319944_renderer_canvas" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id178319944" data-renderer="canvas">Canvas</a>
</li>
<li>
<a id="plot_id178319944_download" class="ggvis-download" data-plot-id="plot_id178319944">Download</a>
</li>
</ul>
</nav>
</div>
...
ggvis.getPlot("plot_id178319944").parseSpec(plot_id178319944_spec);
</script><!--/html_preserve-->
